...
export default App;
  // <View style={{ flex: 1, borderBottomColor: 'black', borderBottomWidth: 1, flexDirection: 'row' }}>
  //         <View style={{ flex: 1, borderColor: 'red', borderRightWidth: 1 }}>
  ...
  //      </View>
  //      <View style={{ flex: 1, borderBottomColor: 'black', borderBottomWidth: 1, flexDirection: 'row' }}>
  //        <View style={{ flex: 2, borderColor: 'red', borderRightWidth: 1 }}>
  //          <TouchableOpacity style={{ width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center' }}>
